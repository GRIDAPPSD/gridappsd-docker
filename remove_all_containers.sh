...
# WARNING: This script removes ALL Docker containers and unused networks
# on your system, not just GridAPPS-D containers. Use with caution!
#
# For removing only GridAPPS-D containers, use: ./stop.sh -c

echo "WARNING: This will remove ALL Docker containers and unused networks on your system!"
